...
Programming Languages:\crlf
{\bf C++:} Here, we have an itemization, where we only want to add
...
again including a {[}link{]} {[}ref{]}, this time placing the url
reference elsewhere in the document to reduce clutter (see source file).

{\bf Java:} We both know this one's pushing it.

Basic knowledge of other programming languages like {\bf TypeScript},
{\bf JavaScript}, {\bf C}, {\bf Dart} and {\bf Swift}.\crlf
As well as markup languages such as {\bf YAML}, {\bf HTML}, {\bf XML}
and {\bf JSON}.\crlf
And tools like {\bf Kubernetes - Kubectl}, {\bf Docker - Podman},
