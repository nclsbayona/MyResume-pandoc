...
\item
  {\bf {\em Python:}}\crlf
  Description of your experience with second-lang, perhaps again
  including a {[}link{]} {[}ref{]}, this time placing the url reference
  elsewhere in the document to reduce clutter (see source file).
\item
  {\bf {\em Java:}}\crlf
...
\item
  ...
  {\bf HTML}, {\bf XML} and {\bf JSON}}, and other tech-related tools
  like {\em {\bf Kubernetes - Kubectl}, {\bf Docker - Podman},
  {\bf Github Actions} and {\bf AWS}}.
\stopitemize
...
Reach me on \useURL[url3][https://t.me/nclsbayona][][Telegram: My
username is nclsbayona]\from[url3]
